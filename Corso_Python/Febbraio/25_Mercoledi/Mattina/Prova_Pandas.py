...
# Caricamento file nel DataFrame
df = pd.read_csv(file_path)

# Stampa le prime righe del DataFrame per confermare (Comando per esplorazione dei dati)
# Di default prende le prime 5 righe, altrimenti legge il numero di righe che inseriamo in parentesi
print(df.head())'''
